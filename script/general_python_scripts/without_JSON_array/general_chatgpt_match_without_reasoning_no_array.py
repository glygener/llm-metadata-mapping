...
CSV_IN = Path()
CSV_OUT = Path()
PROMPT_FILE = Path(r"C:\Users\taylo\OneDrive\Desktop\Github\Test\llm-metadata-mapping\script\LLM_prompts\without_JSON_array\LLM_prompt_without_reasoning_no_array.txt")
