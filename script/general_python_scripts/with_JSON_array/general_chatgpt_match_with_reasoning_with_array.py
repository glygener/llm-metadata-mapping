...
CSV_IN = Path()
CSV_OUT = Path()
PROMPT_FILE = Path(r"C:\Users\taylo\OneDrive\Desktop\Github\Test\llm-metadata-mapping\script\LLM_prompts\with_JSON_array\LLM_prompt_with_reasoning_with_array.txt")
